...
//    m_renderBus = new AudioBus(m_numChannels, offlineRenderSizeQuantum);
    m_renderBus = std::make_unique<AudioBus>(m_numChannels, offlineRenderSizeQuantum);
...
//        render(0, m_renderBus, offlineRenderSizeQuantum, info);
