...
set(labsnd_backend
        ...
        "${LABSOUND_ROOT}/src/backends/miniaudio/miniaudio.c"
        "${LABSOUND_ROOT}/src/backends/miniaudio/miniaudio.h"
        "${LABSOUND_ROOT}/src/jni/labsound_jni.cpp"
        "${LABSOUND_ROOT}/src/jni/LabSoundHelper.hpp"
        "${LABSOUND_ROOT}/src/jni/SoundTouchNode.h"
        "${LABSOUND_ROOT}/src/jni/SoundTouchNode.cpp"
        )
...
#target_link_libraries(LabSound libnyquist libopus libwavpack OpenSLES)

target_link_libraries(LabSound libnyquist libopus libwavpack soundtouch)
